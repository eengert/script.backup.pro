...
Version 0.7.0 adds opt-in Arctic Fuse 3 snapshots to the measured planning,
...
and detects interrupted work for recovery after a crash. Runtime restore stays
